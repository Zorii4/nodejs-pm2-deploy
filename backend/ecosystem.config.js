...
module.exports = {
  apps: [{
    name: 'mesto-backend',
    script: `${DEPLOY_PATH}/src/app.ts`,
    interpreter: `${DEPLOY_PATH}/node_modules/.bin/ts-node`,
  }],
  deploy: {
    production: {
      user: DEPLOY_USER,
      ...
      'post-deploy': `cd ${DEPLOY_PATH} && npm i && pm2 start ecosystem.config.js --env production`,
    },
  },
};
